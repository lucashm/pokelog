...
printZeroEffectiveness([PokemonName|Rest]) :- type(pokemon(PokemonName),EnemyPokemonType),super_effectiveness(fire,EnemyPokemonType),
...
printWeakness([]).
printWeakness([PokemonName|Rest]) :- type(pokemon(PokemonName),EnemyPokemonType),super_effectiveness(fire,EnemyPokemonType),
...
printSuperWeakness([]).
printSuperWeakness([PokemonName|Rest]) :- type(pokemon(PokemonName),EnemyPokemonType),super_effectiveness(fire,EnemyPokemonType),
